...
**Testing**: JUnit6 + kotlinx-coroutines-test + Turbine, Mockito/kotlinx testing doubles, Compose UI tests (ComposeTestRule + Espresso interop), Macrobenchmark harness
